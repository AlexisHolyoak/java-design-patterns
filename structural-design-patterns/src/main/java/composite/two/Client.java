...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" Main Folder Size= " + mainFolder.name + " ** " + mainFolder.getComponentSize() + "kb");
        System.out.println(" Sub Folder1 Size= " + subFolder1.name + " ** " + subFolder1.getComponentSize() + "kb");
        System.out.println(" Sub Folder2 Size= " + subFolder1.name + " ** " + subFolder2.getComponentSize() + "kb");
        System.out.println(
                " File1 in Folder1 size= " + folder1File1.name + " ** " + folder1File1.getComponentSize() + "kb");
        System.out.println(
                " File2 in Folder1 size= " + folder1File2.name + " ** " + folder1File2.getComponentSize() + "kb");
        System.out.println(
                " File1 in Folder2 size= " + folder2File1.name + " ** " + folder2File1.getComponentSize() + "kb");
        System.out.println(
                " File1 in Folder2 size= " + folder2File2.name + " ** " + folder2File2.getComponentSize() + "kb");
    }
}
